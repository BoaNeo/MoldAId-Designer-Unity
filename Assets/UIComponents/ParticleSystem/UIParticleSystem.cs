...
namespace UIComponents.ParticleSystem {
	[ExecuteInEditMode]
	[RequireComponent(typeof(CanvasRenderer), typeof(UnityEngine.ParticleSystem))]
	...
	public class UIParticleSystem : MaskableGraphic {
		...
		protected bool Initialize() {
			...
			if (pSystem == null) {
				pSystem = GetComponent<UnityEngine.ParticleSystem>();
			...
			if (particles == null)
				particles = new UnityEngine.ParticleSystem.Particle[pSystem.main.maxParticles];
		...
		protected override void OnPopulateMesh(VertexHelper vh) {
			...
			for (int i = 0; i < count; ++i) {
				UnityEngine.ParticleSystem.Particle particle = particles[i];
